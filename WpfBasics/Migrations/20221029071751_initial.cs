...
namespace WpfBasics.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("415b36d9-2d82-4a92-a313-48312f8e18c6"), "Одтел продаж" },
                    ...
                    { new Guid("d3c376e4-bce3-4d85-aba4-e3cf49612c94"), "IT одтел" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Name", "Price" },
                values: new object[] { new Guid("efc6578a-00b7-4766-a7e3-79cdba8c294b"), "Органайзер для шурупов", 199.0 });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Name", "Price" },
                values: new object[] { new Guid("f2585221-1aca-4efe-a5e8-c2f4534d1f92"), "Дрель электрическая", 990.0 });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Name", "Price" },
                values: new object[] { new Guid("f7f1e576-af8d-4749-869e-4a794fe69d42"), "Набор 'Новосел'", 52.399999999999999 });
        }
